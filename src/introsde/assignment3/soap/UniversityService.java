 ...
 * 
 */
@WebServiceClient(name = "UniversityService", targetNamespace = "http://soap.assignment3.introsde/", wsdlLocation = "http://localhost:6902/ws/university?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6902/ws/university?wsdl");
